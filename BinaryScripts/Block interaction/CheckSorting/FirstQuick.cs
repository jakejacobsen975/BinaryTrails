...
public class FirstQuick : MonoBehaviour
{
    ...
    {
        new List<int> { 6, 4, 7, 3, 9, 2 },
        new List<int> { 6, 4, 2, 3, 9, 7 },
        new List<int> { 6, 4, 2, 3, 7, 9 },
        new List<int> { 3, 4, 2, 6, 7, 9 },
        new List<int> { 3, 2, 4, 6, 7, 9 },
        new List<int> { 2, 3, 4, 6, 7, 9 }
    };
