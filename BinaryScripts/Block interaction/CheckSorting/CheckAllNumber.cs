...
public class CheckAllNumber : MonoBehaviour
{
    ...
    public bool AllSortsCorrect = false;
    ...
    void Update(){
        ...
        if(firstBubble.BlocksCorrect && firstMerge.BlocksCorrect && firstQuick.BlocksCorrect && secondBubble.BlocksCorrect && secondMerge.BlocksCorrect){
            AllSortsCorrect = true;
        }
    }
}
